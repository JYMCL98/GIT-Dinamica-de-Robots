...
plt.scatter(T,W,color='red',linewidth=3)
#plt.plot([dTwh,dTG],[W,dYA],'r-',label='W',linewidth=5)
plt.plot([T,100],[W,W],'r-',label='W',linewidth=3)
plt.plot([T,Tpr],[W,W],'r-',label='W',linewidth=3)
plt.plot([Tpr,Tpr],[W,0],'r-',label='W',linewidth=3)
plt.plot([T,Tw],[W,0.0098624],'r-',label='W',linewidth=3)
plt.plot([Tw,Tw],[0.00986245,0],'r-',label='Tw',linewidth=3)
plt.plot([T,T],[W,0],'r-',label='Tw',linewidth=3)
plt.plot([T,T],[Ws,W],'r-',label='Tw',linewidth=3)
plt.plot([T,100],[Ws,Ws],'r-',label='Tw',linewidth=3)

#Yasat*calor/0.227+Tw
